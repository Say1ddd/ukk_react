...
const Edit = ({ auth, kategori, flash }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('kategori.update', kategori.slug));
    };
    ...
    return (
        ...
        <Head title="Kategori" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <header>
                <h2 className="text-lg font-medium text-gray-900">{kategori.deskripsi} ({kategori.kategori})</h2>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                ...
                <div>
                    <InputLabel htmlFor="deskripsi" value="Deskripsi Kategori" />
